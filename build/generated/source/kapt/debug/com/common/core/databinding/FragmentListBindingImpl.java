...
public class FragmentListBindingImpl extends FragmentListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.srl_container, 1);
        sViewsWithIds.put(R.id.rf_header, 2);
        sViewsWithIds.put(R.id.rv_data, 3);
        sViewsWithIds.put(R.id.rf_footer, 4);
    }
    // views
    @NonNull
    ...
    private FragmentListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.scwang.smartrefresh.layout.footer.ClassicsFooter) bindings[4]
            , (com.scwang.smartrefresh.header.MaterialHeader) bindings[2]
